    ...
    <ActionSection>
        ...
        <template #description>
            <span class="text-gray-600 dark:text-gray-400">
                Gestionnez et déconnectez-vous de vos sessions actives sur d'autres navigateurs et appareils.
            </span>
        </template>
        ...
        <template #content>
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <span v-else>Dernière session active {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center mt-5">
                ...
                <ActionMessage :on="form.recentlySuccessful" class="ms-3 text-gray-600 dark:text-gray-400">
                    Terminé.
                </ActionMessage>
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    <div class="text-gray-600 dark:text-gray-400">
                        Veuillez entrer votre mot de passe pour confirmer que vous souhaitez déconnecter toutes vos sessions sur d'autres navigateurs et appareils.
                    </div>
                ...
                <template #footer>
                    ...
                    <PrimaryButton
                        class="ms-3 bg-gray-800 dark:bg-gray-200 hover:bg-gray-700 dark:hover:bg-gray-300 text-white dark:text-gray-900"
