...
<template>
    <AppLayout title="Gestion des Utilisateurs">
        ...
        >
            <div class="bg-white dark:bg-zinc-800 rounded-lg p-6 max-w-2xl w-full mx-4 relative">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Modifier l'utilisateur</h3>
                    <button
                        @click="resetEditForm"
                        class="text-gray-400 hover:text-gray-500 text-xl font-medium px-2 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded"
                    >
                ...
                <form @submit.prevent="submitEdit" class="space-y-4">
                    ...
                    <div>
                        <InputLabel class="dark:text-gray-200" value="Nouveau mot de passe (optionnel)" />
                        <TextInput
                    ...
                    <div>
                        <InputLabel class="dark:text-gray-200" value="Confirmation du nouveau mot de passe" />
                        <TextInput
